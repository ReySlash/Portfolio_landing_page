        ...
        <div className="mt-auto flex gap-4 border-t border-gray-900 pt-2">
          ...
          {project.githubUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex min-h-12 flex-1 items-center justify-center rounded-xl bg-gray-800 px-5 py-3 font-semibold text-white transition-all duration-150 hover:scale-[1.02] hover:cursor-pointer hover:bg-gray-700 active:scale-[0.98] sm:max-w-48"
            >
              GitHub
            </a>
          )}
